...
ActiveRecord::Schema.define(version: 20_201_124_190_157) do
  create_table 'caffeinate_campaign_subscriptions', force: :cascade do |t|
    ...
    t.index %w[caffeinate_campaign_id subscriber_id subscriber_type user_id user_type ended_at resubscribed_at unsubscribed_at], name: 'index_caffeinate_campaign_subscriptions'
  ...
  create_table 'caffeinate_mailings', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[caffeinate_campaign_subscription_id send_at sent_at skipped_at], name: 'index_caffeinate_mailings'
